...
export default function OurValues({ content }) {
  return (
    <section className="px-[15rem] py-[10rem] my-[2rem] bg-black text-white flex justify-center items-center gap-[5rem] transition-all duration-300 hover:scale-105 hover:bg-white hover:text-black">
      <div className="">
        <AnimatedSectionText
